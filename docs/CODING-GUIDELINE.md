...
> **Full Documentation**: See `docs/TESTING.md` for complete testing guidelines including:
> - Test file organization
> - Test structure (AAA pattern)
> - Avoiding nesting and mutable variables
> - Unit, component, hook, API, service, and integration test patterns
> - Mocking strategy
