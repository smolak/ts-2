 ...
 *
 * Source: https://github.com/vercel/examples/blob/main/edge-functions/cors/lib/cors.ts
 *
 * TODO: Check if this is still needed. The above source is not available anymore.
 */
